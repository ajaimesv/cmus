...
cmus-y := \
	...
	job.o keys.o keyval.o lib.o load_dir.o locking.o mergesort.o misc.o net.o options.o \
...
cmus-remote: main.o file.o misc.o net.o path.o prog.o xmalloc.o xstrjoin.o
	$(call cmd,ld,$(COMPAT_LIBS) $(OPENSSL_LIBS))
